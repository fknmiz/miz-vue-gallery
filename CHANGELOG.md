...
### Released
- Shipped **miz-vue-gallery** as a public artifact for teams dealing with business operations systems.
...
### Shipped
- Cut the first coherent internal version of **miz-vue-gallery** with stable domain objects, review surfaces, and decision outputs.
